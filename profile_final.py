...
if __name__ == "__main__":
    ...
    for n in range(10, 30):
        ...
        for k in range(K):
            _, unique_hints, unique_time = final(n, True)
            _, random_hints, random_time = final(n, False)
        ...
        print(n, K, total_time_unique/K, total_hints_unique/K, total_time_random/K, total_hints_random/K)
